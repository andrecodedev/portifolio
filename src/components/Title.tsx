...
interface TitleProps {
  ...
  title_8?: string; // destaques curiosidades
}
  ...
  return (
    <>
      <div className="flex flex-1 flex-col justify-center items-center text-center px-4 py-6 sm:px-8 lg:px-16">
        ...
        {title_2 && (
          <h2 className="section-title text-4xl sm:text-4xl md:text-5xl lg:text-[3rem] mb-1 mt-1 pb-2 font-medium text-center font-extrabold bg-gradient-to-r from-[var(--primary-linear-gradient)] to-[var(--text-gray-linear-gradient)] bg-clip-text text-transparent relative inline-block select-none">
            {title_2} {t('page_titles.aboutExpPro')}
          </h2>
        )}

        {title_3 && (
          <h2 className="section-title text-4xl sm:text-4xl md:text-5xl lg:text-[3rem] mb-1 mt-1 pb-2 font-medium text-start font-extrabold bg-gradient-to-r from-[var(--primary-linear-gradient)] to-[var(--text-gray-linear-gradient)] bg-clip-text text-transparent relative inline-block select-none">
        ...
        {title_8 && (
          <h2 className="section-title text-4xl sm:text-4xl md:text-5xl lg:text-[3rem] mb-1 mt-1 pb-2 font-medium text-center font-extrabold bg-gradient-to-r from-[var(--primary-linear-gradient)] to-[var(--text-gray-linear-gradient)] bg-clip-text text-transparent relative inline-block select-none">
            {title_8} {t('AboutHighlights.title')}
          </h2>
        )}
      </div>
    </>
