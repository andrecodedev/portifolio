    ...
    <div data-lenis-prevent="true" className="w-full lg:w-2/3 bg-[var(--bg-primary)] relative lg:overflow-y-auto flex flex-col transition-colors duration-300 min-h-[500px] lg:min-h-0">
      ...
      {currentView === 'hero' ? (
        ...
        <div className="flex-1 relative flex items-center justify-center p-8 animate-in fade-in duration-500">
          <div className="text-center z-30 max-w-lg text-[var(--text-terceiro)] flex flex-col items-center">
             ...
             <h1 className="text-xl font-bold mb-2 text-[var(--text-primary)]">Preview do About em Construção</h1>
             <p className="text-sm opacity-80 leading-relaxed">Conforme você preencher os blocos do menu About à esquerda, as alterações refletirão aqui.</p>
          </div>
