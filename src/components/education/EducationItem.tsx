      ...
      <div className="flex-grow flex flex-row flex-nowrap justify-between gap-4 mt-2">
        ...
        <div className="flex-shrink-0 flex justify-center items-start">
          <a
            ...
            className={`w-12 h-12 flex items-center justify-center rounded-lg text-[var(--white)] transition-all duration-300 transform shadow-lg focus:outline-none focus:ring-2 focus:ring-opacity-50 ${certificadoUrl
